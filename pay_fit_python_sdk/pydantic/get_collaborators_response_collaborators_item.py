...
from pay_fit_python_sdk.pydantic.get_collaborators_response_collaborators_item_addresses import GetCollaboratorsResponseCollaboratorsItemAddresses
from pay_fit_python_sdk.pydantic.get_collaborators_response_collaborators_item_contracts import GetCollaboratorsResponseCollaboratorsItemContracts
from pay_fit_python_sdk.pydantic.get_collaborators_response_collaborators_item_emails import GetCollaboratorsResponseCollaboratorsItemEmails
from pay_fit_python_sdk.pydantic.get_collaborators_response_collaborators_item_phone_numbers import GetCollaboratorsResponseCollaboratorsItemPhoneNumbers

class GetCollaboratorsResponseCollaboratorsItem(BaseModel):
    ...
    emails: GetCollaboratorsResponseCollaboratorsItemEmails = Field(alias='emails')
    ...
    phone_numbers: typing.Optional[GetCollaboratorsResponseCollaboratorsItemPhoneNumbers] = Field(None, alias='phoneNumbers')

    addresses: typing.Optional[GetCollaboratorsResponseCollaboratorsItemAddresses] = Field(None, alias='addresses')
    ...
    contracts: typing.Optional[GetCollaboratorsResponseCollaboratorsItemContracts] = Field(None, alias='contracts')
