...
class GetHealthInsuranceContractsResponseContractsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        required = {
            "tauxCotisationSalariale",
            "codePopulation",
            "tauxCotisationPatronale",
        ...
        class properties:
            ...
            @staticmethod
            def affiliatedContractIds() -> typing.Type['GetHealthInsuranceContractsResponseContractsItemAffiliatedContractIds']:
                return GetHealthInsuranceContractsResponseContractsItemAffiliatedContractIds
            ...
            __annotations__ = {
                ...
                "tauxCotisationPatronale": tauxCotisationPatronale,
                "tauxCotisationSalariale": tauxCotisationSalariale,
            }
    
    tauxCotisationSalariale: MetaOapg.properties.tauxCotisationSalariale
    codePopulation: MetaOapg.properties.codePopulation
    tauxCotisationPatronale: MetaOapg.properties.tauxCotisationPatronale
    affiliatedContractIds: 'GetHealthInsuranceContractsResponseContractsItemAffiliatedContractIds'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["affiliatedContractIds"]) -> 'GetHealthInsuranceContractsResponseContractsItemAffiliatedContractIds': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tauxCotisationPatronale"]) -> MetaOapg.properties.tauxCotisationPatronale: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tauxCotisationSalariale"]) -> MetaOapg.properties.tauxCotisationSalariale: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idContrat", "refContrat", "codePopulation", "codeOption", "affiliatedContractIds", "modeCalculCotisation", "baseDeCotisation", "tauxCotisationPatronale", "tauxCotisationSalariale", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["affiliatedContractIds"]) -> 'GetHealthInsuranceContractsResponseContractsItemAffiliatedContractIds': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tauxCotisationPatronale"]) -> MetaOapg.properties.tauxCotisationPatronale: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tauxCotisationSalariale"]) -> MetaOapg.properties.tauxCotisationSalariale: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idContrat", "refContrat", "codePopulation", "codeOption", "affiliatedContractIds", "modeCalculCotisation", "baseDeCotisation", "tauxCotisationPatronale", "tauxCotisationSalariale", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        tauxCotisationSalariale: typing.Union[MetaOapg.properties.tauxCotisationSalariale, None, decimal.Decimal, int, float, ],
        codePopulation: typing.Union[MetaOapg.properties.codePopulation, None, str, ],
        tauxCotisationPatronale: typing.Union[MetaOapg.properties.tauxCotisationPatronale, None, decimal.Decimal, int, float, ],
        affiliatedContractIds: 'GetHealthInsuranceContractsResponseContractsItemAffiliatedContractIds',
    ...
    ) -> 'GetHealthInsuranceContractsResponseContractsItem':
        return super().__new__(
            cls,
            *args,
            tauxCotisationSalariale=tauxCotisationSalariale,
