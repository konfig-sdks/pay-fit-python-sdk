...
class ContractListFrenchContractsResponseContracts(
    schemas.ListSchema
):
    """NOTE:
                ...
                class all_of_2(
                    ...
                    class MetaOapg:
                        ...
                        class properties:
                            ...
                            class numeroTechniqueTemporaire(
                                schemas.StrBase,
                                schemas.NoneBase,
                                schemas.Schema,
                                schemas.NoneStrMixin
                            ...
                            __annotations__ = {
                                "numeroTechniqueTemporaire": numeroTechniqueTemporaire,
                                "numeroSecuriteSociale": numeroSecuriteSociale,
                            }
                    
                    numeroSecuriteSociale: MetaOapg.properties.numeroSecuriteSociale
                    numeroTechniqueTemporaire: MetaOapg.properties.numeroTechniqueTemporaire
                    
                    @typing.overload
                    def __getitem__(self, name: typing_extensions.Literal["numeroTechniqueTemporaire"]) -> MetaOapg.properties.numeroTechniqueTemporaire: ...
                    
                    @typing.overload
                    def __getitem__(self, name: typing_extensions.Literal["numeroSecuriteSociale"]) -> MetaOapg.properties.numeroSecuriteSociale: ...
                    
                    @typing.overload
                    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                    
                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["numeroTechniqueTemporaire", "numeroSecuriteSociale", ], str]):
                        # dict_instance[name] accessor
                        return super().__getitem__(name)
                    
                    
                    @typing.overload
                    def get_item_oapg(self, name: typing_extensions.Literal["numeroTechniqueTemporaire"]) -> MetaOapg.properties.numeroTechniqueTemporaire: ...
                    
                    @typing.overload
                    def get_item_oapg(self, name: typing_extensions.Literal["numeroSecuriteSociale"]) -> MetaOapg.properties.numeroSecuriteSociale: ...
                    
                    @typing.overload
                    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                    
                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["numeroTechniqueTemporaire", "numeroSecuriteSociale", ], str]):
                        return super().get_item_oapg(name)
                    ...
                    def __new__(
                        cls,
                        *args: typing.Union[dict, frozendict.frozendict, ],
                        numeroSecuriteSociale: typing.Union[MetaOapg.properties.numeroSecuriteSociale, None, str, ],
                        numeroTechniqueTemporaire: typing.Union[MetaOapg.properties.numeroTechniqueTemporaire, None, str, ],
                        _configuration: typing.Optional[schemas.Configuration] = None,
                        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                    ) -> 'all_of_2':
                        return super().__new__(
    ...
    def __new__(
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ContractListFrenchContractsResponseContracts':
        return super().__new__(
            cls,
            arg,
            _configuration=_configuration,
