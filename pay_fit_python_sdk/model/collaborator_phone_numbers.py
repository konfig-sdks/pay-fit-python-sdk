...
class CollaboratorPhoneNumbers(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['CollaboratorPhoneNumbersItem']:
            return CollaboratorPhoneNumbersItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['CollaboratorPhoneNumbersItem'], typing.List['CollaboratorPhoneNumbersItem']],
    ...
    def __getitem__(self, i: int) -> 'CollaboratorPhoneNumbersItem':
