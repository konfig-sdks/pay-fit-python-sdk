...
from pay_fit_python_sdk.type.collaborator_addresses import CollaboratorAddresses
from pay_fit_python_sdk.type.collaborator_contracts import CollaboratorContracts
from pay_fit_python_sdk.type.collaborator_emails import CollaboratorEmails
from pay_fit_python_sdk.type.collaborator_phone_numbers import CollaboratorPhoneNumbers

class RequiredCollaborator(TypedDict):
...
class OptionalCollaborator(TypedDict, total=False):
    ...
    phoneNumbers: CollaboratorPhoneNumbers

    addresses: CollaboratorAddresses
    ...
    contracts: CollaboratorContracts

class Collaborator(RequiredCollaborator, OptionalCollaborator):
    pass
