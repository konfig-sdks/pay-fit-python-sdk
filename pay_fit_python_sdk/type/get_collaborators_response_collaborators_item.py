...
from pay_fit_python_sdk.type.get_collaborators_response_collaborators_item_addresses import GetCollaboratorsResponseCollaboratorsItemAddresses
from pay_fit_python_sdk.type.get_collaborators_response_collaborators_item_contracts import GetCollaboratorsResponseCollaboratorsItemContracts
from pay_fit_python_sdk.type.get_collaborators_response_collaborators_item_emails import GetCollaboratorsResponseCollaboratorsItemEmails
from pay_fit_python_sdk.type.get_collaborators_response_collaborators_item_phone_numbers import GetCollaboratorsResponseCollaboratorsItemPhoneNumbers

class RequiredGetCollaboratorsResponseCollaboratorsItem(TypedDict):
...
class OptionalGetCollaboratorsResponseCollaboratorsItem(TypedDict, total=False):
    ...
    phoneNumbers: GetCollaboratorsResponseCollaboratorsItemPhoneNumbers

    addresses: GetCollaboratorsResponseCollaboratorsItemAddresses
    ...
    contracts: GetCollaboratorsResponseCollaboratorsItemContracts

class GetCollaboratorsResponseCollaboratorsItem(RequiredGetCollaboratorsResponseCollaboratorsItem, OptionalGetCollaboratorsResponseCollaboratorsItem):
    pass
