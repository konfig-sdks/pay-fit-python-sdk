...
from pay_fit_python_sdk.exceptions_base import ApiValueError
from pay_fit_python_sdk.exceptions import ClientConfigurationError
from pay_fit_python_sdk.exceptions import InvalidHostConfigurationError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://partner-api.payfit.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("pay_fit_python_sdk")
        ...
        return [
            {
                ...
                'description': "The PayFit API production server",
            }
        ]
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "https://oauth.payfit.com/token") -> None:
